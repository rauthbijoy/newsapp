...
export default class News extends Component {
    ...
    async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=f011d18a507a48fcb063644ac134a24c&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick= async() =>{
        console.log('prev')
        let url = `https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=f011d18a507a48fcb063644ac134a24c&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({loading: true});
        let data = await fetch(url);
        let parsedData = await data.json()
        this.setState({
  ...
  render() {
    return (
      <>
        ...
        <div className="sm:px-2 flex justify-between max-w-7xl mx-auto items-center mb-4">
          <button
